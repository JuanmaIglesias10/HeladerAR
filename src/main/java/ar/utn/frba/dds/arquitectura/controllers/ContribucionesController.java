...
public class ContribucionesController implements ICrudViewsHandler {
    ...
    public ContribucionesController(
            ...
            RepositorioProvincia repositorioProvincia, RepositorioModeloHeladera repositorioModeloHeladera,
    ...
    public void getHacerseCargoHeladeraRecomendaciones(Context context) throws IOException {
        Map<String, Object> model = new HashMap<>();

        //TODO eliminar este hardcodeo. recibir la lat y long por formulario o recibir siempre las del usuario
        ...
        model.put("puntosRecomendados", dtosLugar);
        context.render("contribuciones/persona_juridica/hacerse_cargo_heladera2.hbs",model);
    }
    ...
    public void postHacerseCargoHeladeraRecomendacionesPaso1(Context context){
        ...
        Ciudad ciudadRecibida = repositorio.buscarPorNombre(ciudad,"Ciudad",Ciudad.class);
        ...
        context.render("contribuciones/persona_juridica/hacerse_cargo_heladera3.hbs",model);
    }
    ...
    public void postSuscribirseHeladera(Context context){
        ...
        if(Integer.parseInt(checkViandasDisponibles)==1){
            suscripcion.setCantidadViandasDisponibles(Integer.parseInt(viandasDisponibles));
            QuedanNViandasDisponibles quedanNViandasDisponibles = new QuedanNViandasDisponibles();
            opciones.add(quedanNViandasDisponibles);
        }

        if(Integer.parseInt(checkViandasFaltantes)==1){
        ...
        if(Integer.parseInt(checkDesperfectoYTraslado)==1){
    ...
    public void recibirCSV(Context context) {
        try {
            ...
            //TODO que redirija bien al seleccionar "guardar"
            SessionUtils.mostrarPantallaDeExito(context,
