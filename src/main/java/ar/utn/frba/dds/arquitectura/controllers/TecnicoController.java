...
public class TecnicoController implements ICrudViewsHandler {
    ...
    public void postRegistrarVisitaPaso1(Context context) {
        ...
        System.out.println("Tipo de incidente: " + tipoIncidenteInput);
    ...
    public void postRegistrarVisitaPaso2(Context context) {
        ...
        System.out.println("Tipo de incidente desde formulario: " + tipoIncidente);
        ...
        System.out.println("Tipo de incidente: " + tipoIncidente);
        if (idIncidente != null) {
